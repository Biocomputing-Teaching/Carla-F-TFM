...
\begin{figure*}
    \begin{subfigure}{0.6\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{pairplot_matrix_train4.png} 
        \caption{}%%Pairplot correlation matrix
        %%\label{fig:subim1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.6\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{migheatmap_train4.png}
...
\begin{figure*}
    \centering 
     \includegraphics[width=0.6\textwidth]{cor_plot3_pchembl_train4.png}	
...
\begin{figure*}
    \begin{subfigure}{0.6\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{pairplot_matrix_predict_chemdiv.png} 
        \caption{}
        %%\label{fig:subim1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.6\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{migheatmap_predict_chemdiv.png}
        \caption{}
        %%\label{Figure8}
    \end{subfigure}
...
\begin{figure}[h]
 ...
 \begin{figure*}
    ...
    \begin{subfigure}{1\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth, height=5cm]{barplot_matrix_predict_chemdiv.png} 
        \caption{}
        %%\label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{1\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth, height=5cm]{barplot_matrix_predict_zinc.png}
        \caption{}
        %%\label{fig:subim2}
    \end{subfigure}
