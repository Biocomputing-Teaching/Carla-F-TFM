...
\begin{figure}[h]
 ...
 \begin{figure}[h]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.8\linewidth, height=4cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/barplot_matrix_predict_chemdiv.png} 
        \caption{}
        %%\label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.8\linewidth, height=4cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/barplot_matrix_predict_zinc.png}
        \caption{}
        %%\label{fig:subim2}
    \end{subfigure}
