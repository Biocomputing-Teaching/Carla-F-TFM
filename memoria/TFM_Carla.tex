...
\begin{figure}[ht]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/pairplot_matrix_train4.png} 
        \caption{Pairplot correlation matrix}
        %%\label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/migheatmap_train4.png}
        \caption{Correlation matrix}
        %%\label{fig:subim2}
    \end{subfigure}
    
    \caption{Correlation analysis from the dataset used to train the model}
    \label{Figure6}
\end{figure}
...
\begin{figure}[ht]
 ...
 For the dataset of the second train, the variables most related to each other, as seen in Figure~\ref{Figure10}, are MW with Heavy Atom Counts and TPSA with Heavy Atom Counts, with correlation values of 0,98 and 0,9 respectively. The variables that are most related to the activity value (Figure~\ref{Figure11}) are H-bond acceptor and TPSA with values 0,41 and 0,34. 

\begin{figure}[ht]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/pairplot_matrix_predict_chemdiv.png} 
        \caption{Pairplot correlation matrix}
        %%\label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/migheatmap_predict_chemdiv.png}
        \caption{Correlation matrix}
        %%\label{Figure8}
    \end{subfigure}
    
    \caption{Correlation analysis from the dataset used to the first predict model}
    \label{Figure8}
\end{figure}
...
\begin{figure}[ht]
 ...
 \begin{figure}[ht]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/barplot_matrix_predict_chemdiv.png} 
        \caption{A. First predict. ChemDiv}
        %%\label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm]{/Users/carlafeliu/Docs/Master/TFM/github/TFM/output/barplot_matrix_predict_zinc.png}
        \caption{B. Second predict. Zinc}
        %%\label{fig:subim2}
    \end{subfigure}
    
    \caption{Barplot matrix analysis from predicted results among IC50. }
    \label{Figure15}
\end{figure}
...
Regarding the features analyzed in the prediction results based on the correlation of variables, in all three cases analyzed (see Figures~\ref{Figure6},~\ref{Figure8},~\ref{Figure10}), we can see a strong correlation between the MW and Heavy Atom Count features. This may be due to the fact that heavier molecules tend to have more heavy atoms.
